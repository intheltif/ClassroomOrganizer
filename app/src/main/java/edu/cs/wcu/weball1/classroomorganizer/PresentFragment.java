...
/**
 * The Fragment that displays the list of present students in the TabLayout.
 *
 * @author Evert Ball
 * @version 07/06/2020
 */
public class PresentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RelativeLayout rl = (RelativeLayout) inflater.inflate(R.layout.fragment_present, container, false);
        RecyclerView recView = rl.findViewById(R.id.rv_present);
